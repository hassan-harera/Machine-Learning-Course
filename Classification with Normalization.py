...
ax.scatter(positive["Test 1"], positive["Test 2"], s=30, c="g", label="Accepted", marker="o")
ax.scatter(negative["Test 1"], negative["Test 2"], s=30, c="r", label="Rejected", marker="x")
